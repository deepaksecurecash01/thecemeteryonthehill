...
const Footer = () => {
  return (
    <div className="relative  w-full">
      ...
      <div className="flex justify-start space-x-44 py-20">
        ...
        <div className=" col-span-1 flex flex-col justify-start items-start space-y-12">
        ...
        <div className=" col-span-1 flex flex-col justify-evenly items-start font-roboto space-y-6">
          <iframe
      ...
      <p className="text-black font-roboto text-center bg-gold/75 py-2">
