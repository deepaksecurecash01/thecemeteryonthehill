  ...
  return (
    <>
      ...
      <div className="w-full lg:w-full flex flex-col lg:flex-row gap-4 lg:gap-2 2xl:gap-4">
        ...
        <Element elementData={data[30]} plot_number={31} />
        <Element elementData={data[31]} plot_number={32} />
        <Element elementData={data[32]} plot_number={33} />
        <Element elementData={data[33]} plot_number={34} />
        <Element elementData={data[34]} plot_number={35} />
        <Element elementData={data[35]} plot_number={36} />
        <Element elementData={data[36]} plot_number={37} />
        <Element elementData={data[37]} plot_number={38} />
        <Element elementData={data[38]} plot_number={39} />
        <Element elementData={data[39]} plot_number={40} />
      </div>
      <div className="w-full lg:w-full flex flex-col lg:flex-row gap-4 lg:gap-2 2xl:gap-4">
        <Element elementData={data[40]} plot_number={41} />
        <Element elementData={data[41]} plot_number={42} />
        <Element elementData={data[42]} plot_number={43} />
        <Element elementData={data[43]} plot_number={44} />
        <Element elementData={data[44]} plot_number={45} />
        <Element elementData={data[45]} plot_number={46} />
        <Element elementData={data[46]} plot_number={47} />
        <Element elementData={data[47]} plot_number={48} />
        <Element elementData={data[48]} plot_number={49} />
        <Element elementData={data[49]} plot_number={50} />
        <Element elementData={data[50]} plot_number={51} />
        <Element elementData={data[51]} plot_number={52} />
        <Element elementData={data[52]} plot_number={53} />
        <Element elementData={data[53]} plot_number={54} />
        <Element elementData={data[54]} plot_number={55} />
        <Element elementData={data[55]} plot_number={56} />
        <Element elementData={data[56]} plot_number={57} />
        <Element elementData={data[57]} plot_number={58} />
        <Element elementData={data[58]} plot_number={59} />
        <Element elementData={data[59]} plot_number={60} />
      </div>
    </>
  );
};
