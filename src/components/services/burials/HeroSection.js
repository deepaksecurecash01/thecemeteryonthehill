          ...
          <div className="w-full flex justify-center items-center">
            <div className="w-full flex flex-col gap-8 order-2 xl:order-1">
              <p className="text-base md:text-lg text-justify text-paragraph">
                ...
                now eco-friendly funeral options or green burials, resomation or
                water cremation, and one of the newest ideas in ecological
              ...
              <p className="text-base md:text-lg text-justify text-paragraph">
                ...
                aboriginal culture, traditional practices when an aborigine dies
                include a smoking ceremony and painting red ochre on all living
                spaces to drive away the spirit of the deceased; and the death
                ceremony, which includes practices such as painting the bodies
                of the mourners and bringing families together to share food,
                song, and dance.
              </p>
            </div>
          </div>
