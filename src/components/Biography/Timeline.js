      ...
      {timelineData.map(
        (item, index) =>
          ...
          index % 2 === 0 && (
            ...
            >
              <div className="h-10 w-10 bg-transparent border-4 border-primary bg-white rounded-full absolute top-0 z-10 circle left-1/2 transform -translate-x-1/2 hidden md:block" />

              {/* First item */}
              <div className="relative py-[10px] px-6 lg:px-[50px] w-full md:w-[50%] flex justify-center items-center md:justify-end">
                <div className="h-10 w-10 bg-transparent border-4 border-primary bg-white rounded-full absolute top-0 z-10 circle -right-[20px] md:hidden" />
                <div className="text-box relative py-[20px] px-[30px] rounded-[6px] text-[15px] flex flex-col gap-2 md:text-center">
              ...
              {index + 1 < timelineData.length && (
                <div className="relative py-[10px] px-6 lg:px-[50px] w-full md:w-[50%] flex justify-center items-center md:justify-start">
                  <div className="h-10 w-10 bg-transparent border-4 border-primary bg-white rounded-full absolute top-0 z-10 circle -right-[20px] md:hidden" />
                  <div className="text-box relative py-[20px] px-[30px] rounded-[6px] text-[15px] flex flex-col gap-2 md:text-center">
                    <h3 className="text-3xl md:text-4xl lg:text-4xl font-bold text-primary font-display">
