...
const Timeline = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center gap-0 items-center w-full md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px] py-6 md:py-2 mb-12 timeline">
      <div className="relative  w-full flex flex-col md:flex-row items-start justify-center h-full card">
        <div className="animation flex gap-6 flex-col w-[50%]">
          {evenItems.map((item, index) => (
            <div
              key={index}
              className="relative lg:px-6 w-full h-full flex justify-center items-center md:justify-center "
            >
              <div
                className={`h-10 w-10 bg-transparent border-4 border-primary bg-white rounded-full absolute top-6 z-10 circle -right-[20px]`}
              />
              <div className="absolute  p-4 bg-primary h-10 w-10 top-6 z-10 rounded-full overflow-hidden flex justify-center items-center circle -right-[20px]">
                <Image
                  src={"/images/left-arrow.svg"}
                  layout="fill"
                  objectFit="contain"
                  loading="lazy"
                  className="rounded-md  object-center p-3 absolute"
                />
              </div>
              <div
                className={`absolute hidden  bg-primary w-[50%] h-[6px] top-10 right-0`}
              />
              <div
                className={`text-box relative py-[20px] px-6 rounded-[6px] text-[15px] flex flex-col gap-2 md:text-end`}
              >
        ...
        <div className=" mt-16 flex gap-6 flex-col w-[50%]">
          {oddItems.map((item, index) => (
            ...
            >
              <div
                className={`h-10 w-10 bg-transparent border-4 border-primary bg-white rounded-full absolute top-6 z-10 circle -left-[20px]`}
              />
              <div className="absolute  p-4 bg-primary h-10 w-10 top-6 z-10 rounded-full overflow-hidden flex justify-center items-center circle -left-[20px]">
                <Image
              ...
              <div
                className={`absolute hidden  bg-primary w-[50%] h-[6px] top-10 left-0`}
              />
              <div
                className={`text-box relative py-[20px] px-6 rounded-[6px] text-[15px] flex flex-col gap-2 md:text-start`}
              >
                <h3 className="text-3xl md:text-4xl lg:text-4xl font-bold text-primary font-display">
                  {item.year}
                </h3>
