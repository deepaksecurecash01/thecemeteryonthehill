          ...
          <div className="swiper-wrapper">
            {testimonials.map((testimonial, index) => {
              ...
              return (
                <SwiperSlide
                  key={index}
                  className="swiper-slide testimonial-slide space-y-12  bg-testi_bg bg-no-repeat bg-contain bg-center"
                  style={{
                    display: "flex",
                ...
                >
                  <q className="text-grey font-trajanpro3 px-4 text-xl md:text-lg">
                    {testimonial.review}
                  </q>
                  ...
                  <div className="space-y-3 flex flex-col justify-center items-center">
                    ...
                    <h3 className="text-4xl text-black font-semibold font-roboto">
                      {testimonial.fullname}
                    </h3>
                    <p className="text-xl md:text-lg font-medium text-grey font-roboto">
