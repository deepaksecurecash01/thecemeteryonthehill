...
const RoseGarden = ({ data }) => {
  return (
    <>
      <div className="w-full lg:w-auto lg:h-16 flex flex-col lg:flex-row gap-4 lg:gap-2 2xl:gap-4 xl:h-20">
      ...
      <div className="w-full lg:w-auto flex flex-col lg:flex-row gap-4 lg:gap-2 2xl:gap-4 xl:h-20">
        ...
        <div className="font-roboto cursor-pointer flex justify-center items-center">
          <span className="text-secondary font-display border border-secondary text-center text-sm md:text-base flex justify-center items-center rounded-full hover:bg-gray-100 hover:text-primary hover:border hover:border-primary w-16 h-16 xl:h-20 xl:w-20">
            Rose <br /> Bush
          </span>
        </div>
