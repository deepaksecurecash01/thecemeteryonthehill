...
const RenewForm = () => {
  ...
  return (
    <div className="w-full max-h-screen overflow-y-auto no-scrollbar overflow-x-hidden">
      <div className="h-[52rem] md:max-h-[1024px] my-auto bg-contact-form-bg popup-form-bg bg-center bg-no-repeat md:bg-contain flex justify-center items-center py-24 md:py-24 lg:py-20">
        <form
        ...
        >
          ...
          <div className="relative z-0 w-full mb-5 lg:mb-2 xl:mb-5 group contact">
            ...
            {errors.dateOfDeath && (
              <span className="text-red-500">{errors.dateOfDeath.message}</span>
            )}
          </div>
