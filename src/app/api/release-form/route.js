...
const prepareAdminEmailMessage = (
  ...
  return {
    ...
    subject: `Release form submission for Plot ${formData.PlotNumber}`,
    html: `
      <!DOCTYPE html>
      <html lang="en">
        <head>
          ...
          <title>Release Form Submission</title>
        </head>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse;">
                  ...
                  <tr style="border-top:1px solid #dddddd;">
                    <td colspan="2" style="padding:18px;color:#222222;line-height:160%;text-align:left;">
                      <h1 style="font-size:24px;font-weight:bold;">Release Form Submission</h1>
                      <p>A website visitor submitted the following details through the Release Form, please review this in the Online Services Portal:</p>
                      <table>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td style="padding:5px 9px;">${
                            formData.InternmentType
                          }</td>
                        </tr>
                        <tr>
                          <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;"><strong>ReturnAshes:</strong></td>
                          <td style="padding:5px 9px;">${
                            formData.ReturnAshes
                          }</td>
                        </tr>
                         ${
                           ReturnAddress
                             ? `
                          <tr>
                            <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;width:160px;"><strong>Return Address:</strong></td>
                            <td style="padding:5px 9px;">${ReturnAddress}</td>
                          </tr>`
                             : ""
                         }
                              ${
                                Suburb
                                  ? `
                          <tr>
                            <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;width:160px;"><strong>Suburb:</strong></td>
                            <td style="padding:5px 9px;">${Suburb}</td>
                          </tr>`
                                  : ""
                              }
                                    ${
                                      State
                                        ? `
                          <tr>
                            <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;width:160px;"><strong>State:</strong></td>
                            <td style="padding:5px 9px;">${State}</td>
                          </tr>`
                                        : ""
                                    }
                                          ${
                                            PostCode
                                              ? `
                          <tr>
                            <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;width:160px;"><strong>Postal Code:</strong></td>
                            <td style="padding:5px 9px;">${PostCode}</td>
                          </tr>`
                                              : ""
                                          }
                                               ${
                                                 Country
                                                   ? `
                          <tr>
                            <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;width:160px;"><strong>Country:</strong></td>
                            <td style="padding:5px 9px;">${Country}</td>
                          </tr>`
                                                   : ""
                                               }
                        <tr>
                          <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;"><strong>Signature:</strong></td>
                          <td style="padding:5px 9px;">
                            <a href="${uploadedSignatureUrl}" target="_blank" style="cursor: pointer;">
                              <img src="${uploadedSignatureUrl}" alt="Signature" width="100" />
                            </a>
                          </td>
                        </tr>
                        <tr>
                          <td style="background-color:#9e8034;color:#ffffff;padding:5px 9px;"><strong>ID:</strong></td>
                          <td style="padding:5px 9px;">
                            <a href="${uploadedFileUrl}" target="_blank" style="cursor: pointer;">
                              <img src="${uploadedFileUrl}" alt="ID" width="100" />
                            </a>
                          </td>
                        </tr>
...
const prepareCustomerEmailMessage = (formData) => {
  return {
    ...
    from: "The Cemetery on The Hill <hello@thecemeteryonthehill.com.au>", // Updated sender name and email
    subject: `${formData.PlotNumber} Release Request | The Cemetery on The Hill`,
    html: `
      <!DOCTYPE html>
      <html lang="en">
        <head>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse;">
                  ...
                  <tr style="border-top:1px solid #dddddd;">
                    <td colspan="2" style="padding:18px;color:#222222;line-height:160%;text-align:left;">
                      ...
                      <p>Thank you for submitting your release request for Plot ${formData.PlotNumber}.</p>
                      <p>We have received your request and will review this as soon as possible.</p>
                      <p>You will receive an update once the review has been performed, please keep an eye out for this as we may require further details.</p>
...
export async function POST(request) {
  try {
    ...
    const ReturnAddress = formData.get("ReturnAshesDetails.Address");
    const Suburb = formData.get("ReturnAshesDetails.Suburb");
    const State = formData.get("ReturnAshesDetails.State");
    const PostCode = formData.get("ReturnAshesDetails.PostCode");
    const Country = formData.get("ReturnAshesDetails.Contry");
    ...
    const emailCustomerMessage = prepareCustomerEmailMessage(releaseFormData);
