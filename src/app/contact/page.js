  ...
  return (
    <section className="relative min-h-screen flex justify-center items-center overflow-hidden">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="lg:h-screen w-full flex flex-col items-center pt-10">
        ...
        <div className="relative h-full w-full grid grid-cols-1 lg:grid-cols-2 place-items-center overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-1 lg:h-full w-full py-6 sm:px-8 xl:px-12 md:pr-4 space-y-6 md:flex md:flex-col justify-start lg:justify-center items-center order-2 ">
            <div className="bg-contact-form-bg  contact-form-bg bg-center bg-contain bg-no-repeat h-full w-full lg:h-[40rem] xl:h-[40rem] 2xl:h-[48rem] xl:w-full flex flex-col justify-center lg:justify-between items-center py-20 md:py-10 2xl:py-20 ">
              <ContactForm />
            </div>
          </div>
        </div>
