        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full h-full overflow-hidden relative xl:py-8 xl:gap-4">
          ...
          <div className="w-full flex justify-center items-center">
            <div className="w-full flex flex-col gap-8 order-2 xl:order-1">
              <div className="flex flex-col gap-4">
                <p className="text-paragraph text-base  tracking-wide lg:text-lg">
                  The interment of ashes, following a cremation, is the burial
                  of ashes into their final resting place. Family and friends of
                  the deceased can gather together at the interment site for an
                  ashes interment ceremony, in hopes to bring closure by saying
                  their final goodbyes.
                </p>
                <p className="text-paragraph text-base  tracking-wide lg:text-lg">
                  The Cemetery on the Hill provides a peaceful and beautiful
                  final resting place for your loved one’s ashes. We guarantee
                  the utmost respect and care for every one laid to rest within
                  our historic cemetery.
                </p>
                <p className="text-paragraph text-base  tracking-wide lg:text-lg">
                  What type of interment service will best suit your needs?
                  Let’s start discussing your options. Call us 08 8317 6044 .
                </p>
              </div>
            </div>
          </div>
